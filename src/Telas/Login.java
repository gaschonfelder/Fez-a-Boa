...
public class Login extends javax.swing.JFrame {
    ...
    private void BtnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnLoginActionPerformed
        ...
        try{
            ...
            while(conectar.getResultSet().next()){
                novoUsuario.setEmail(conectar.getResultSet().getString(1));
                novoUsuario.setSenha(conectar.getResultSet().getString(2));
            }
            if(novoUsuario.getEmail().equals("")){
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        char coringa = TxtSenha.getEchoChar();
        if (coringa=='*') {
